This tutorial shows how to setup an alchemical protein mutation involving a charge changing-transformation. Specifically, the tutorial looks at the E23G salt-bridge breaking mutation in [oncoprotein MDM2, as part of this study](https://pubs.acs.org/doi/10.1021/acs.jctc.5c01648).

It is recommended to go through [BioSimSpace Protein FEP tutorial](https://biosimspace.openbiosim.org/tutorials/protein_mutations.html) in order to understand how BioSimSpace leverages the region-of-interest (ROI) functionallity to setup alchemical protein transformations.
